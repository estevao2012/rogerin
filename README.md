...
| `revisa-rogerin` | Revisa um PR do GitHub (só o diff, não roda nem edita nada): classifica achados por severidade e crava **Approve** ou **Request changes** — qualquer médio/alto bloqueia. Posta o review em inglês profissional com comentários inline (só depois do teu OK) e te dá o recap na voz do Rogerin. Dispara com "revisa esse PR", "review this PR"... |
